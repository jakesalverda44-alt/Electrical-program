...
const STANDARD_OPENING =
  'Accurate Power & Technology (APT) is pleased to present this proposal for the ' +
  'electrical scope of work on the above-referenced project. The following pages ' +
  'detail our complete scope of work, allowances, exclusions, pricing, and terms ' +
  'and conditions. We appreciate the opportunity to provide this quotation and ' +
  'look forward to partnering with you to deliver quality electrical construction ' +
...
export async function buildProposalDocx(data: ProposalJSON, bidMeta: BidMeta = {}): Promise<Buffer> {
  ...
  // ── Opening Statement (standard APT boilerplate) ─────────────────────────────
  children.push(navyHeader('OPENING STATEMENT'));
  children.push(bodyPara(STANDARD_OPENING));
  children.push(blank());
