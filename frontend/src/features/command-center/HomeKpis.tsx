...
export default function HomeKpis({ bids, gens, wonJobs, repNames, onNav }: Props) {
  const user = useUser();
  ...
  return (
    <div className="sd-root">
      ...
      <div className="sd-grid">
        {/* ── Left: open pipeline + funnel ── */}
        <div>
          <div className="sd-card">
            <div className="ch">
              Open pipeline
              <span className="sp"/>
              <button className="panel-link" onClick={() => onNav('generators/pipeline')}>
